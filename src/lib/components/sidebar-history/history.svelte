...
<div
  class="group-data-[collapsible=icon]:hidden flex-1 overflow-hidden flex flex-col"
>
  {#if !user}
    <SidebarGroup>
      <SidebarGroupContent>
  ...
  {:else}
    <SidebarGroup class="flex-1 overflow-hidden">
      <SidebarGroupContent class="flex-1 overflow-hidden">
        <SidebarMenu class="flex-1 overflow-hidden">
