<script lang="ts">
  ...
  const commands = [
    ...
    // Grading
    { id: 'grade', label: 'grade', icon: GraduationCapIcon, desc: 'Submit academic grade' },
    { id: 'mark', label: 'mark', icon: GraduationCapIcon, desc: 'Add exam marks' },
    { id: 'attendance', label: 'attendance', icon: CalendarCheckIcon, desc: 'Record attendance status' },
    
    // Onboarding
    { id: 'register', label: 'register', icon: UserPlusIcon, desc: 'Register new student or staff' },
    { id: 'enroll', label: 'enroll', icon: UserPlusIcon, desc: 'Enroll student in a class' },
    { id: 'assign', label: 'assign', icon: UserCheckIcon, desc: 'Assign teacher or role' },
    
    // Governance
    { id: 'update', label: 'update', icon: SettingsIcon, desc: 'Update system entity record' },
    { id: 'edit', label: 'edit', icon: PenIcon, desc: 'Edit existing records' },
    { id: 'rename', label: 'rename', icon: TagIcon, desc: 'Rename class or subject' },
    { id: 'ban', label: 'ban', icon: BanIcon, desc: 'Revoke active system access' },
    { id: 'suspend', label: 'suspend', icon: BanIcon, desc: 'Suspend user workspace access' },
    { id: 'reset', label: 'reset', icon: RefreshCwIcon, desc: 'Reset context or workspace state' },
    
    // Core/Default
    { id: 'search', label: 'search', icon: SearchIcon, desc: 'Deep database entity search' },
    { id: 'find', label: 'find', icon: SearchIcon, desc: 'Alias for entity lookup' },
    { id: 'switch', label: 'switch', icon: ShuffleIcon, desc: 'Switch active workspace/tenant' },
    { id: 'status', label: 'status', icon: ActivityIcon, desc: 'Check health & active context' },
  ];
...
<div class="w-full min-w-[320px] bg-popover/90 backdrop-blur-2xl border border-border/10 rounded-xl shadow-2xl p-1 animate-in fade-in slide-in-from-bottom-2 duration-200">
  ...
  <div class="flex flex-col gap-0.5 max-h-[270px] overflow-y-auto scrollbar-slick px-0.5">
