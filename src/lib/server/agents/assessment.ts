  ...
  assistants: [
    ...
    // —— Coordinator Assistant ——
    {
      ...
      instructions: [
        ...
        "   - After successful creation, confirm with the student's name, enrolled class/section, and CRITICALLY, you MUST display the automatically generated `temporaryPassword` for the student and `temporaryParentPassword` for the guardian in your response so they can log in.",
        "",
        ...
        "",
        "10. **Password Management (updateUserPassword tool)**:",
        "    - **Who can use this**: Coordinators can manage passwords for any staff/users. Staff can change their own password.",
        "    - **If a coordinator wants to reset/change a staff password**:",
        "        1. Find the user ID or email.",
        "        2. Call `updateUserPassword` with the new password.",
        "    - **If a user wants to change their own password**:",
        "        1. Ask for the new password.",
        "        2. Call `updateUserPassword` using their `userId` or `email` from context.",
        "",
