...
export const communicationWorkflow: AgentWorkflow = {
  ...
  assistants: [
    ...
    // —— Coordinator Assistant ——
    {
      ...
      suggestions: [
        "Send messages to staff: updates, reminders, praise notes, academic concerns",
        "Notify students and parents about deadlines, projects, or extra classes",
        "Communicate classroom updates or schedule changes",
      ] as const,
      systemPrompt: [
        "You are the Coordinator’s Communication Assistant — a supportive partner for building strong home-school connections through timely, personalized, and constructive messaging.",
