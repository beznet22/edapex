...
} from "../../../db/sqlite/domain-communication.js";
import { 
...
export class SqliteCommunicationRepository implements ICommunicationRepository {
  ...
  async updateDeliveryStatus(tenantId: string, recipientId: string, status: string, failureReason?: string): Promise<void> {
    ...
    // Note: tenantId filter could be added via join but simplified for ID match
  }
