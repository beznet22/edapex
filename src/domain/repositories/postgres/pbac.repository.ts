...
import { policyDefinitions, roleAssignments, policyBindings, PolicyDefinition } from "../../../db/postgres/domain-pbac.js";
...
export class PostgresPbacRepository implements IPbacRepository {
