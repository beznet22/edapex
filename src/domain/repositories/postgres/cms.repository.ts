...
import { contentNodes } from "../../../db/postgres/domain-cms.js";
import { ICmsRepository, IContentNode } from "../../interfaces/cms.interface.js";
import { eq, and } from "drizzle-orm";

export class PostgresCmsRepository implements ICmsRepository {
  ...
  async updateContentNode(tenantId: string, id: string, data: Partial<IContentNode>): Promise<void> {
    await db.update(contentNodes)
      .set(data as any)
      .where(and(eq(contentNodes.tenantId, tenantId), eq(contentNodes.id, id)));
  }
