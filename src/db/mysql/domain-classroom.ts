...
export const classroomSessions = mysqlTable(
  "classroom_sessions",
  {
    ...
    status: mysqlEnum("status", ["scheduled", "active", "paused", "completed"])
      .notNull()
      .default("scheduled"),
...
export const classroomMemoryLedger = mysqlTable(
  "classroom_memory_ledger",
  {
    id: varchar("id", { length: 36 })
      .primaryKey()
    ...
    parentLedgerId: varchar("parent_ledger_id", { length: 36 }), // Session lineage for compacted chains
    ...
    isCompacted: tinyint("is_compacted").default(0), // Memory ledger compaction flag
    createdAt: timestamp("created_at").defaultNow(),
  },
  (table) => ({
...
export const classroomParticipants = mysqlTable(
  "classroom_participants",
  {
    id: varchar("id", { length: 36 })
      .primaryKey()
...
export const classroomWhiteboardState = mysqlTable(
  "classroom_whiteboard_state",
  {
    id: varchar("id", { length: 36 })
      .primaryKey()
