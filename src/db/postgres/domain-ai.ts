...
export const aiSessions = aiSchema.table("ai_sessions", {
  ...
  tokenStats: jsonb("token_stats").$type<TokenStats>(), // Dialect-agnostic token tracking
  isCompressed: boolean("is_compressed").default(false), // Compaction flag
  metadata: jsonb("metadata").$type<ChatMetadata>(),
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow(),
});

export const aiMessages = aiSchema.table(
  "ai_messages",
  {
    id: uuid("id")
      .primaryKey()
    ...
    cacheBreakpoint: boolean("cache_breakpoint").default(false), // [HIGH-FIDELITY] Anthropic-style cache control
...
export const aiVotes = aiSchema.table(
  "ai_votes",
  {
    tenantId: uuid("tenant_id")
      .notNull()
...
export const aiDocuments = aiSchema.table(
  "ai_documents",
  {
    id: uuid("id")
      .primaryKey()
...
export const aiSuggestions = aiSchema.table(
  "ai_suggestions",
  {
    id: uuid("id")
      .primaryKey()
...
export const aiAgents = aiSchema.table(
  "ai_agents",
  {
    id: uuid("id")
      .primaryKey()
...
export const aiAgentActions = aiSchema.table(
  "ai_agent_actions",
  {
    id: uuid("id")
      .primaryKey()
...
export const aiToolInvocations = aiSchema.table(
  "ai_tool_invocations",
  {
    id: uuid("id")
      .primaryKey()
...
export const aiGoals = aiSchema.table(
  "ai_goals",
  {
    id: uuid("id")
      .primaryKey()
...
export const aiTasks = aiSchema.table(
  "ai_tasks",
  {
    id: uuid("id")
      .primaryKey()
    ...
    tenantId: uuid("tenant_id")
      .notNull()
      .references(() => tenants.id),
    sessionId: uuid("session_id").references(() => aiSessions.id), // [CONTROL PLANE] Lineage to Session
    ...
    invocationType: varchar("invocation_type", { length: 50 }).default("manual"), // [CONTROL PLANE]
    ...
    usageJson: jsonb("usage_json").$type<TaskUsageJson>(), // [CONTROL PLANE] Tokens/Cost
...
export const aiApprovals = aiSchema.table(
  "ai_approvals",
  {
    id: uuid("id")
      .primaryKey()
...
export const aiCostEvents = aiSchema.table(
  "ai_cost_events",
  {
    id: uuid("id")
      .primaryKey()
...
export const aiActivityLogs = aiSchema.table(
  "ai_activity_logs",
  {
    id: uuid("id")
      .primaryKey()
