...
**The next architectural upgrade used in cutting-edge AI systems** [Version 2](arch_v2.md):

**Hierarchical Multi-Agent Architecture for EdApex**

This design would allow the platform to run **hundreds of specialized micro-agents per school** while remaining fully controllable and explainable.
